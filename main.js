...
function combineDateTime(dateStr, timeStr) {
  ...
  function buildActivityWeek() {
    ...
    for (let monthOffset = 0; monthOffset < monthsToShow; monthOffset++) {
      ...
      // Explicit farmer's market entries for visibility
      if (yearForMonth === 2026 && actualMonth === 8 && d === 1) add(fmt(yearForMonth, actualMonth, d), { category: 'community', title: "Winkler Farmer's Market", time: 'Tue 4-6 PM · Central Station parking lot', link: 'https://www.visitwinkler.ca/events' });
      if (yearForMonth === 2026 && actualMonth === 8 && d === 8) add(fmt(yearForMonth, actualMonth, d), { category: 'community', title: "Winkler Farmer's Market", time: 'Tue 4-6 PM · Central Station parking lot', link: 'https://www.visitwinkler.ca/events' });
      if (yearForMonth === 2026 && actualMonth === 8 && d === 15) add(fmt(yearForMonth, actualMonth, d), { category: 'community', title: "Winkler Farmer's Market", time: 'Tue 4-6 PM · Central Station parking lot', link: 'https://www.visitwinkler.ca/events' });
      if (yearForMonth === 2026 && actualMonth === 8 && d === 22) add(fmt(yearForMonth, actualMonth, d), { category: 'community', title: "Winkler Farmer's Market", time: 'Tue 4-6 PM · Central Station parking lot', link: 'https://www.visitwinkler.ca/events' });
      if (yearForMonth === 2026 && actualMonth === 8 && d === 29) add(fmt(yearForMonth, actualMonth, d), { category: 'community', title: "Winkler Farmer's Market", time: 'Tue 4-6 PM · Central Station parking lot', link: 'https://www.visitwinkler.ca/events' });
      if (yearForMonth === 2026 && actualMonth === 9 && d === 6) add(fmt(yearForMonth, actualMonth, d), { category: 'community', title: "Winkler Farmer's Market", time: 'Tue 4-6 PM · Central Station parking lot', link: 'https://www.visitwinkler.ca/events' });
